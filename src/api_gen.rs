...
impl Display for ApiOverrideOperator {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ApiOverrideOperator::SET => f.write_str("set"),
            ApiOverrideOperator::NoOverride => f.write_str(""),
            ApiOverrideOperator::DECREMENT => f.write_str("decr"),
            ApiOverrideOperator::BEST => f.write_str("bset"),
            ApiOverrideOperator::INCREMENT => f.write_str("incr"),
        }
    }
}
